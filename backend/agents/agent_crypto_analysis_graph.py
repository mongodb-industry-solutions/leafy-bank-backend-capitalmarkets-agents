...
from backend.agents.tools.tool_crypto_trends import calculate_crypto_trends_tool
from backend.agents.tools.tool_crypto_momentum_indicators import calculate_crypto_momentum_indicators_tool
...
def create_workflow_graph(checkpointer=None):
    ...
    ...
    graph.add_edge("...", "portfolio_overall_diagnosis_node")
