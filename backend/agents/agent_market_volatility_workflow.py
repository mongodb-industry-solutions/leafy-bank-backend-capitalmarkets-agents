...
from agent_market_volatility_node_definition import chatbot_node, tool_node
from agent_market_volatility_chat_history import temp_mem
...
if __name__ == '__main__':
    ...
    initial_content = "Evaluate the Market Volatility Index (VIX indicator) fluctuation and provide a recommended action based on your analysis."
